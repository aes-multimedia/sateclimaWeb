...
<html lang="es">
    <head>
		<title>ESTA ESTA ESCRITO POR WILLY v2 Sateclima S.L. - Alpedrete - Tel. <?php echo $telefono ?></title>
...
(function( $ ){
	...
	<div class="container-fluid slider-home-height">
		<div class="row height100">
			
			<div class="col-12 col-md-12 col-xl-2 content-logo-home">
				<div class="row logo-home effect effect-fade effect-delay-200">
					<a href="index.htm"><img src="<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=7") ?>" alt="Logotipo Sateclima" title="Ir al inicio"></a>
				</div>
			</div>
			<div class="col-12 col-md-12 col-xl-12">
				<img class="logo_banner" src="<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=2") ?>">
				<div class="row height100">
					<div class="flexslider left  effect effect-fade effect-delay-400">
						<div class="services-slider">
							<ul id="SliderText" >
								<li><a href="#">Sateclima</a></li>
								<li><a href="es/viesmann.html">Viesmann</a></li>
								<li><a href="es/wolf.html">Wolf</a></li>
								<li><a href="main.php.html">Área privada</a></li>
								<li><a href="contacto.html">Contacto</a></li>
							</ul>
						</div>
						<ul class="slides">
							<li style="background: url(<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=1") ?>) center; background-size: 100%;">
								<div class="meta">
									<div class="content-meta">
										<h1><strong>Buscamos</strong> la mejor <strong>solución</strong> posible a sus problemas</h1>
									</div>
								</div>    
							</li>
						</ul>
	  ...
	  $(window).load(function(){
			$('.flexslider').flexslider({
			  ...
			  before: function( slider ){
				 ...
				 var index = $slides.filter(".flex-active-slide").next().index();
				 
				 $($("#SliderText").children().removeClass("active").get( index<0 ? 0 : index )).addClass("active");
...
<section id="company">
	<div class="container-fluid">
		<div class="row align-items-stretch">
			<div class="col-12 col-lg-6 offset-md-0 col-xl-5 offset-xl-2">
				<div class="row text-company">
					<div class="address-home effect effect-fade effect-delay-600">
						<div><h1>Servició <strong>Técnico</strong></h1></div>
						<div>
						...
						<div>
							<a class="link-address-home" href="mailto:sateclima@sateclima.es">
								<div class="icon"><img src="images/icons/ico-mail.png" alt="Icono sobre"></div>
								<div class="txt-link"><?php echo $email?></div>

 						</a>
						</div>
					</div>
					<div class="col-12 box-txt-company">
						<div class=" effect effect-fade effect-delay-200"> 
							<h2><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=1"); ?></h2>
							<p><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=2");?> </p>
							<p><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=3");?> </p>
							<p><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=4");?> </p>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 col-lg-6 col-xl-5">
				<div class="row photo-company" style="background-image: url('<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=3") ?>')">
					<div class="logo-company effect effect-fade effect-delay-800">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="col-md-10 offset-md-1 vert-offset-bottom-3" style="position: relative;">
				<div class="row text-left effect effect-fade effect-delay-200">	
					<h2><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=5"); ?></h2>
				</div>
			</div>
		</div>
		<div class="col-md-10 offset-md-1 vert-offset-bottom-3" style="position: relative;">
			<div class="row">
				<div class="col-xl-3  effect effect-fade effect-delay-400">
					<p><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=6"); ?></p>
					<p>Hendrerit interdum mollis turpis consequat molestie tortor, nullam aptent cursus enim cubilia montes pretium, augue etiam.</p>
				</div>
				<div class="col-xl-9">
					<div class="row">
						<div class="col-6 effect effect-fade effect-delay-600 img-worker">
							<div class="col-12">
								<div class="row">
									<div class="name-worker">
									<?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=7"); ?>								</div>
									<img src="<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=5") ?>" alt="Imagen Viesmann">
								</div>
							</div>
							<div class="col-12 social-worker">
								<div class="row">
									<ul>
										<li><a target="_blank" href="#"><i class="fas fa-arrow-alt-circle-right"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-6 effect effect-fade effect-delay-800 img-worker">
							<div class="col-12">
								<div class="row">
									<div class="name-worker"><?php echo bdd_obtenerValor("Secciones", "texto", "id_seccion=8"); ?></div>
									<img src="<?php echo bdd_obtenerValor("Imagenes", "ruta", "id_imagen=6") ?>" alt="Imagen Wolf">
								</div>
							</div>
							<div class="col-12 social-worker">
								<div class="row">
