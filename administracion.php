...
<html lang="es">
    <head>
        ...
        <!-- Administracion -->
        <link rel="stylesheet" href="css/administracion.css" type="text/css" media="all">
						...
						<nav id="SideMenu" class="navik-menu-overlay submenu-vertical">
							<ul>
								<li class="current-menu">
									<a class="" href="es/index.php">Inicio</a>
								</li>
								<li class="">
...
<main>
    <section class="section_administracion">
        <table class="tabla_datos">
            <tr>
                <th>NOMBRE</th><th>IMAGEN</th><th>Editar</th><th>Eliminar</th>
            </tr>
            <?php foreach($resultado_imagenes as $imagen){ ?>
            <tr>
                <td><?php echo $imagen["nombre"] ?></td>
                <td><img src="<?php echo $imagen["ruta"] ?>"></td>
                <td>
                    <form action="ruru.php" method="POST" enctype="multipart/form-data">
                        <label for="file">
                            <i class="fas fa-pencil-alt"></i>
                        </label>
                        <input type="hidden" name="ruta_antigua" value="<?php echo $imagen["ruta"] ?>" />
                ...
                <td>
                    <form action="borrar.php" method="POST">
                        ...
                        <input name="input_name" id="delete" type="button" onchange="this.form.submit()"/>
                    </form>
                </td>
            </tr>
            <?php } ?>
